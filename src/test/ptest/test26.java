 ...
 *	               expr1 == expr2
 * Con i primitive type, possiamo testare anche l'algoritmo di binary promo-
 * tion, mentre con i reference type, potremo testare l'algoritmo di cast 
 * conversion.
 */
  ...
  void pippo() 
   {
     ...
     if (10==11);          // l'expr vale false.
     if (10==10);          // l'expr vale true.
     if (10==11.3);        // l'expr vale false.
     if (10.8==11);        // l'expr vale false.
     if (10==10.0);        // l'expr vale true.
     if (10.6==10.6);      // l'expr vale true.	

     if (var1==var2);      // Arithmetic Promotion su var2.
     
     if (true==false);     // l'expr vale false.	
     if (false==false);    // l'expr vale true.	

     if (var3==var4);
     if (var5==var4);      // errore!!! var5 e' ref. type, mentre var4 e' bool.
     ...
     /*
      * Da qui inizia una serie di test nuovi, attivati per la versione del
      * 07/11/97 perche' ora sono disponibili sia le interfacce che il carica-
      * mento di classi esterne.
      */

/*
 * Attenzione, per ora non posso completare il test dell'algoritmo di cast 
