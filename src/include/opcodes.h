 ...
 * file opcode.h
 *
 * descrizione: definizione dei codici operativi delle varie istruzioni JVM.
 *
...
/*
int initcast[]={  0,133,134,135,  0,145,146,147 ,
		136,  0,137,138,  0,  0,  0,  0 ,
		139,140,  0,141,  0,  0,  0,  0 ,
		142,143,144,  0,  0,  0,  0,  0 ,
		  0,  0,  0,  0,192,  0,  0,  0 };  
...
/*
 * Codici Operativi utilizzati in particolari occasioni per semplificare
 * la generazione del codice. In realta' questi codici sono gia' stati defini-
 * ti sopra con un altro nome.
 */

#define INIT_STORE_INDEX 0x36
#define INIT_STORE       0x3B
#define INIT_LOAD_INDEX  0x15
#define INIT_LOAD        0x1A
